#############################################################################################
#### show position of injuries, and proportion of injuries fatal/non-fatal by main species ##
#############################################################################################

# import data
dat <- read.delim2(file="injurydat.txt", header=T, sep="\t")
